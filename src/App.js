...
function App() {
  ...
  const htmlTitle = useRef()
  const leftSide = useRef()
  const rightSide = useRef()
  const cssTitle = useRef()
  const cssleftSide = useRef()
  const cssrightSide = useRef()
  const cssleftSideContainer = useRef()
  const sassTitle = useRef()
  const gitTitle = useRef()
  const gittext = useRef()
  const nodeTitle = useRef()
  const nodeLetter = useRef()
  const htmlAnimate = useRef(null)
  ...
  const nextjsAnimation = () => {
    nextjsTitle.current.style.cssText = "top:-25px;transition:top 2s";
  }
  const htmlAnimation = () =>{
    htmlTitle.current.style.cssText = "top:-25px;transition:top 2s";
     htmlAnimate.current = setTimeout(() => {
      leftSide.current.style.cssText = "fill:#c5c5c5;stroke:transparent";
      rightSide.current.style.cssText = "fill:#EBEBEB;stroke:transparent";
    }, 1600);
  }
  const cssAnimation = () => {
    cssTitle.current.style.cssText = "top:-25px;transition:top 2s";
    cssAnimate.current = setTimeout(() => {
      cssleftSide.current.style.cssText = "fill:#c5c5c5;stroke:transparent";
      cssrightSide.current.style.cssText = "fill:#EBEBEB;stroke:transparent";
      cssleftSideContainer.current.style.cssText = "fill:#2965f1;stroke:transparent";
    }, 1600);
  }
  const sassAnimation = () =>{
    sassTitle.current.style.cssText = "top:-25px;transition:top 2.5s";
  }
  const gitAnimation = () => {
    gitTitle.current.style.cssText = "top:-25px;transition:top 2";
    gitAnimate.current = setTimeout(() => {
      gittext.current.style.cssText = "fill:#413000;stroke:transparent";
    }, 1600);
  }
  const nodeAnimation = () => {
    nodeTitle.current.style.cssText = "top:-25px;transition:top 2";
    nodeAnimate.current = setTimeout(() => {
      nodeLetter.current.style.cssText = "fill:#3c873a;stroke:transparent";
    }, 1600);
  }
  const hiddenAnimation = (x) => {
    reactTitle.current.style.cssText = "top:0; transition:none";
    nextjsTitle.current.style.cssText = "top:0; transition:none";
    htmlTitle.current.style.cssText = "top:0; transition:none";
    clearTimeout(htmlAnimate.current);
    leftSide.current.style.cssText = "fill:none;stroke:#585858";
    rightSide.current.style.cssText = "fill:none;stroke:#7f7f7f";
    cssTitle.current.style.cssText = "top:0; transition:none";
    cssleftSideContainer.current.style.cssText = "fill:none;stroke:#2965f1";
    cssleftSide.current.style.cssText = "fill:none;stroke:#585858";
    cssrightSide.current.style.cssText = "fill:none;stroke:#7f7f7f";
    clearTimeout(cssAnimate.current)
    sassTitle.current.style.cssText = "top:0; transition:none";
    gitTitle.current.style.cssText = "top:0; transition:none";
    gittext.current.style.cssText = "fill:none;stroke:#413000";
    clearTimeout(gitAnimate.current)
    nodeTitle.current.style.cssText = "top:0; transition:none";
    nodeLetter.current.style.cssText = "fill:none;stroke:#3c873a";
    clearTimeout(nodeAnimate.current)
  }
  useEffect(() => {
    c()
    reactTitle.current.style.cssText = "top:0;";
    nextjsTitle.current.style.cssText = "top:0;";
    htmlTitle.current.style.cssText = "top:0;";
    cssTitle.current.style.cssText = "top:0;";
    sassTitle.current.style.cssText = "top:0;";
    gitTitle.current.style.cssText = "top:0;";
  ...
  return (
    <div className="App">
      ...
      <div className="description" id="about">
        ...
        I participate in projects ranging from developing data structures to designing websites and mobile apps. For
        more info, check out my <a href="https://github.com/ague26">Github</a> or <a href="https://www.linkedin.com/in/alexanderguevara/">LinkedIn</a>. You can also email me at 
        <a href="mailto:alexgue26@hotmail.com"> alexgue26@hotmail.com</a>.</p>
      </div>
      <div className="skills-section">
        <div className="skills">
          <div className="programming-language" id="programming">
            ...
            <div className="listed-skills">
              <h2>Programming Languages</h2>
              <div className="languages">
                <div id="react-container">
                  <p ref={reactTitle}>React & React Native</p>
                  <svg version="1.1" viewBox="0 0 841.9 595.3" preserveAspectRatio="xMinYMin meet" onMouseEnter={reactAnimation} onMouseLeave={hiddenAnimation} enableBackground="new 0 0 841.9 595.3">
                    <path stroke="rgb(97, 218, 251)" className="react" d="M666.3,296.5c0-32.5-40.7-63.3-103.1-82.4c14.4-63.6,8-114.2-20.2-130.4c-6.5-3.8-14.1-5.6-22.4-5.6v22.3
                    ...
                    <circle cx="420.9" cy="296.5" r="45.7" stroke="rgb(97, 218, 251)" className="react" />
                  </svg>
                </div>
                <div id="nextjs-container">
                  <p ref={nextjsTitle}>Next.js</p>
                  <svg  height="124px" viewBox="0 0 207 124" version="1.1" onMouseEnter={nextjsAnimation} onMouseLeave={hiddenAnimation}>
                    <path stroke="#000000" className="nextjs" d="M48.9421964,32.6320058 L87.9011585,32.6320058 L87.9011585,35.7136421 L52.5134345,35.7136421 L52.5134345,58.9070103 L85.7908813,58.9070103 L85.7908813,61.9886466 L52.5134345,61.9886466 L52.5134345,87.4526941 L88.306981,87.4526941 L88.306981,90.5343303 L48.9421964,90.5343303 L48.9421964,32.6320058 Z M91.3912326,32.6320058 L95.5306221,32.6320058 L113.8738,58.0960534 L132.622801,32.6320058 L158.124498,0.286809811 L116.22757,60.7722112 L137.817329,90.5343303 L133.51561,90.5343303 L113.8738,63.4483691 L94.1508254,90.5343303 L89.9302715,90.5343303 L111.682358,60.7722112 L91.3912326,32.6320058 Z M139.359455,35.713642 L139.359455,32.6320058 L183.756439,32.6320058 L183.756439,35.7136421 L163.302983,35.7136421 L163.302983,90.5343303 L159.731745,90.5343303 L159.731745,35.7136421 L139.359455,35.713642 Z" id="EXT"></path>
                    <polygon stroke="#000000" className="nextjs" points="0.202923647 32.6320058 4.66697141 32.6320058 66.2235778 124.303087 40.785176 90.5343303 3.93649086 37.0111732 3.77416185 90.5343303 0.202923647 90.5343303"></polygon>
                    <path stroke="#000000" className="nextjs" d="M183.396622,86.5227221 C184.134938,86.5227221 184.673474,85.9601075 184.673474,85.233037 C184.673474,84.5059658 184.134938,83.9433513 183.396622,83.9433513 C182.666993,83.9433513 182.11977,84.5059658 182.11977,85.233037 C182.11977,85.9601075 182.666993,86.5227221 183.396622,86.5227221 Z M186.905793,83.1297235 C186.905793,85.2763149 188.460599,86.678523 190.727662,86.678523 C193.142388,86.678523 194.601647,85.233037 194.601647,82.7229099 L194.601647,73.8855335 L192.655968,73.8855335 L192.655968,82.7142542 C192.655968,84.1078073 191.952397,84.8521899 190.710289,84.8521899 C189.598473,84.8521899 188.842785,84.1597409 188.816727,83.1297235 L186.905793,83.1297235 Z M197.146664,83.0172011 C197.285642,85.2503478 199.153145,86.678523 201.932686,86.678523 C204.903321,86.678523 206.762139,85.1811034 206.762139,82.792155 C206.762139,80.9138876 205.702439,79.8752151 203.131364,79.2779777 L201.750279,78.9404092 C200.117298,78.5595622 199.457158,78.0488813 199.457158,77.1573541 C199.457158,76.0321243 200.482113,75.296398 202.019547,75.296398 C203.478806,75.296398 204.48639,76.0148135 204.668797,77.1660091 L206.562359,77.1660091 C206.44944,75.0626962 204.590622,73.5825873 202.045605,73.5825873 C199.309495,73.5825873 197.48542,75.0626962 197.48542,77.2871878 C197.48542,79.1221767 198.519063,80.2127835 200.786126,80.7407758 L202.401734,81.1302779 C204.060773,81.5197807 204.790402,82.091051 204.790402,83.0431676 C204.790402,84.1510859 203.643842,84.9560573 202.08035,84.9560573 C200.403939,84.9560573 199.240006,84.2030196 199.074971,83.0172011 L197.146664,83.0172011 Z" id=".JS"></path>
                  </svg>
                </div>
                <div id="html-container">
                  <p ref={htmlTitle}>HTML5</p>
                  <svg  height="124px" viewBox="0 0 512 512" version="1.1" onMouseEnter={htmlAnimation} onMouseLeave={hiddenAnimation}>
                    <g className="html">  
                      <path stroke="#E34F26" d="M71,460 L30,0 481,0 440,460 255,512" />
                      <path stroke="#EF652A" d="M256,472 L405,431 440,37 256,37" />
                      <path ref={leftSide} stroke="#585858" d="M256,208 L181,208 176,150 256,150 256,94 255,94 114,94 115,109 129,265 256,265zM256,355 L255,355 192,338 188,293 158,293 132,293 139,382 255,414 256,414z" />                    
                      <path ref={rightSide} stroke="#7f7f7f" d="M255,208 L255,265 325,265 318,338 255,355 255,414 371,382 372,372 385,223 387,208 371,208zM255,94 L255,129 255,150 255,150 392,150 392,150 392,150 393,138 396,109 397,94z" />                  
                    </g>
                  </svg>
                </div>
                <div id="css-container">
                  <p ref={cssTitle}>CSS3</p>
                  <svg  height="124" viewBox="50 100 400 419.99998" version="1.1" onMouseEnter={cssAnimation} onMouseLeave={hiddenAnimation}>
                    <g className="css">
                      <polygon
                        points="437.367,100.62 404.321,470.819 255.778,512 107.644,470.877 74.633,100.62" stroke="#264de4"/>
                      <path ref={cssleftSideContainer} stroke="#2965f1" d="M260,480 L370,450 400,130 256,130" />
                      <g stroke="#585858" ref={cssleftSide}>  
                        <polygon
                ...
                <div id="node-container">
                  ...
                  <svg height="124px" viewBox="0 -60 560 375.929" version="1.1" onMouseEnter={nodeAnimation} onMouseLeave={hiddenAnimation}>
                    <g transform="translate(-115.94417,-501.42131)" className="node">
                      ...
                      />
                      <path stroke="#3c873a" ref={nodeLetter}
